...
- Misc Bug fixes 
- Promote lookup fields to SharePoint Lists
- Rich Text Editor Support using Trumbowyg
...
3) Create an HTML file for your form with the corresponding JavaScript and CSS as needed (see examples for... well... examples)
