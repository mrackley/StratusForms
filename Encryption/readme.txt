...
Encrypt Example Basic Usage:

1) Create a list called "Secure" with the following field:
...
5) Link the Content Editor Web Part to SiteAssets/Encryption/enrypt.html
6) Ta Da!
